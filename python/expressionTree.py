...
def greaterPrecedence(operator1,operator2): #verifica se o operator1 tem maior precedência se comparado ao 2
    ...
    while token:
        ...
        try:
            ...
            if element in operators: #verificamos se o elemento é um operador e se a pilha contem elementos
                while stack:
                    topOfStack = stack[-1]
                    if greaterPrecedence(element,topOfStack): #se o operador do topo da pilha tiver maior precedência
